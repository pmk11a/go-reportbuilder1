    ...
    begin
      ...
      case KodeReport of
       ...
       30362: Begin
                ...
                TglAwal8.Visible:=False;
                End;
       20401, 20402, 20403, 20404, 20405,20406,204041, 20409 :
                begin
      ...
      Label104.Visible:=Tipe23.Visible;
                  case KodeReport of
                     20409 :
                     begin
                        ShowReportPreview(' Histori Piutang',7);
                        Valas8.Visible:=false;
                        Perkiraan8.Text:='131'  ;
                        Perkiraan8.Visible:=false;
                        gbPeriode8.Visible:=false;
                        CBODEt7.Visible:=false;
                        Button2.Visible:=false;
     ...
     20401,20406,20409 :
            begin     // kartu Piutang
              ...
              begin
                 ...
                 if KodeReport=20409 Then
                 Begin
                 SQL.Add('exec Sp_ReportKartuPiutangCust :0,:1,:2,:3,:4,:5,:6,:7,:8');
                 Prepared;
                 Parameters[0].Value:=TglAwal8.Date;
                 Parameters[1].Value:=TglAkhir8.Date;
                 Parameters[2].Value:=Awal8.Text;
              ...
              case kodereport of
               ...
               Begin
                if Valas8.ItemIndex=0 then
                  frxReport1.LoadFromFile(ExtractFilePath(Application.ExeName)+'ReportFiles\ReportKartuPiutangCust.fr3')
                else
                  frxReport1.LoadFromFile(ExtractFilePath(Application.ExeName)+'ReportFiles\ReportKartuPiutang2.fr3');
               End;
              End;
                ...
                25701,25702,25703,25704,25711,25712,25713,25721,25722,25723,25731,25732,25733,25741,25742,25761,25762,25763:
                    ...
                    if Cbojns.ItemIndex=0 then
                        begin
                         ...
                         25711,25712,25713:sql.add('Exec  Sp_reportBeliAccDet :0,:1,:2,:3,:4,:5,:6');
                         ...
                         Parameters[0].value:='T';
                          ...
                          Parameters[4].Value:='';
                          case kodereport of
                          2530201,2530202,2530203,2540201,2540202,2540203,25711,25712,25713,25741,25742,25721,25722,25723,25761,25762,25763,
                          25731,25732,25733:
                          ...
                          End;
                          case kodereport of
                          25711,25712,25713 : Parameters[6].value:= ComboBox1.ItemIndex;
                          end;
...
begin
  ...
  begin
    case KodeReport of
    20301,20302, 20303, 20304, 20305, 20401,20402, 20403, 20404, 20405,20406,30362,204041,20409 :
      begin
